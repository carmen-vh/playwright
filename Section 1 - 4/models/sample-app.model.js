...
exports.SampleAppPage = class SampleAppPage {
    constructor(page) {
        ...
        this.loginText = page.locator("#loginstatus") // # indicates ID
    }

    // functions
    async navigateToSampleApp() {
      await this.page.goto('http://uitestingplayground.com/'); // go to sample app page
    }
    ...
    async fillPasswordField(password) {
        await this.passwordField.file(password)
    }
